...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-lazo/node_modules/lazo/lib/public/server/syncher.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-lazo/node_modules/lazo/lib/public/server/syncher.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-lazo/node_modules/lazo/lib/public/server/</a> &#187; syncher.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">define(['l!base', 'l!serviceProxy'], <span class="fstat-no" title="function not covered" >function (Base, ServiceProxy) {</span>
&nbsp;
    /**
     ...
     * @constructor
     */
<span class="cstat-no" title="statement not covered" >    var Syncher = Base.extend({</span>
&nbsp;
        /**
...
&nbsp;
         ...
         */
        fetch: <span class="fstat-no" title="function not covered" >function(options) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error('fetch method not implemented provided');</span>
        },
&nbsp;
        /**
         ...
         * @return must call the success or error callback passing the response
         */
        add: <span class="fstat-no" title="function not covered" >function(attributes, options) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error('add method not implemented provided');</span>
        },
&nbsp;
        /**
         ...
         * @return must call the success or error callback passing the response
         */
        update: <span class="fstat-no" title="function not covered" >function (attributes, options) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error('update method not implemented provided');</span>
        },
&nbsp;
        /**
         ...
         * @return must call the success or error callback passing the response
         */
        destroy: <span class="fstat-no" title="function not covered" >function (options) {</span>
<span class="cstat-no" title="statement not covered" >            throw new Error('destroy method not implemented provided');</span>
        }
&nbsp;
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return Syncher;</span>
});
&nbsp;</pre></td></tr>
</table></pre>
</div>
